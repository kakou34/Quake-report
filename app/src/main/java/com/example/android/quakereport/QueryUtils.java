...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //looping throug the features Array
            for(int i=0; i < features.length(); i++){
                //getting the earthquake object at position i
                JSONObject earthquake = features.getJSONObject(i);
                //extracting properties
                JSONObject properties = earthquake.optJSONObject("properties");
                //extracting mag, place and time from the properties object
                double mag = properties.getDouble("mag");
                String place = properties.getString("place");
                long time = properties.getInt("time");
                String url =properties.getString("url");
                //creating an Earthquake object with parameters mag, place and time
                Earthquake earthquake1 = new Earthquake(mag,place,time,url);
                //adding the earthquake object to the ArrayList
